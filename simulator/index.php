...
<?php
    function printRealData(){
        // mock data
        $commitList = parse("scribe-java.txt"); //"mockTest.txt","CPSC304CoolTeam.txt","RxJava.txt", "scribe-java.txt"
        // real data
...
<?php
    function printDependency(){
        // mock data
        $php_array = readXML("scribe-java.xml"); //"scribe-java.xml", "CPSC304CoolTeam.xml"
        // real data
